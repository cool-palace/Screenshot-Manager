...
void JournalCreation::clear_all() {
...
void JournalCreation::set_enabled(bool enable) {
    ...
    ui->private_switch->setEnabled(true);
    ui->load_subs->setEnabled(false);
    ui->slider->setEnabled(false);
    ui->slider->setValue(0);
    ui->list_view->setEnabled(false);
    ui->gallery_view->setEnabled(false);
    ui->preview_view->setEnabled(false);
    ui->poll_preparation->setEnabled(false);
    ui->title_view->setEnabled(false);
    ui->last_used_limit->setEnabled(false);
    ui->check_log->setEnabled(false);
    ui->post->setEnabled(false);
    ui->back->show();
    ui->text->show();
    ui->ok->show();
}
...
void JournalCreation::start_mode() {
